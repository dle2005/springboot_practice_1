...
@Slf4j
@Configuration
public class SkipExceptionConfiguration {

    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;
    private final EntityManagerFactory entityManagerFactory;

    public SkipExceptionConfiguration(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, EntityManagerFactory entityManagerFactory) {
    ...
    @Bean
    public Job skipExceptionJob() throws Exception {
        return this.jobBuilderFactory.get("ExecutionListenerConfiguration")
                .incrementer(new RunIdIncrementer())
                .start(this.skipExceptionStep(null))
    ...
    @Bean
    @JobScope
    public Step skipExceptionStep(@Value("#{jobParameters[allow_duplicate]}") String allowDuplicate) throws Exception {
        return this.stepBuilderFactory.get("skipExceptionStep")
